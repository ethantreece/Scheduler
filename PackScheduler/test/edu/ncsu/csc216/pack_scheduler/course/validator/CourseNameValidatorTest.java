...
/**
 * CourseNameValidatorTest tests the CourseNameValidator class to make sure all the the requirements are met
 * Test for valid states
...
class CourseNameValidatorTest {
	...
	/** c is an instance of CourseNameValidator to be used for testing */
